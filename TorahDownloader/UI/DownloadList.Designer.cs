namespace TorahDownloader.UI
{
	partial class DownloadList
	{
		...
		private void InitializeComponent()
		{
			...
			this.blockedProgressBar1 = new Controls.BlockedProgressBar();
			...
			this.blockedProgressBar1.Direction = TorahDownloader.Controls.BlockedProgressBar.DirectionMode.Horizontal;
			...
			this.blockedProgressBar1.UpdateMode = TorahDownloader.Controls.BlockList.UpdateMode.All;
			// 
			// lvwSegments
			// 
		...
		private TorahDownloader.Controls.BlockedProgressBar blockedProgressBar1;
	}
}
